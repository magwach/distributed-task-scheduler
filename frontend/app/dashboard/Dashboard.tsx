    ...
    <>
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">// monitoring {counts.total} registered tasks</p>
        </div>
      ...
      <div className="stats-grid">
        <div className="stat-card" style={{ '--stat-color': 'var(--accent-cyan)' } as React.CSSProperties}>
          <div className="stat-label">Total Tasks</div>
          <div className="stat-value cyan">{counts.total}</div>
          <div className="stat-icon">◈</div>
        </div>
        <div className="stat-card" style={{ '--stat-color': 'var(--status-pending)' } as React.CSSProperties}>
          <div className="stat-label">Pending</div>
          <div className="stat-value yellow">{counts.pending}</div>
          <div className="stat-icon">◷</div>
        </div>
        <div className="stat-card" style={{ '--stat-color': 'var(--status-running)' } as React.CSSProperties}>
          <div className="stat-label">Running</div>
          <div className="stat-value cyan">{counts.running}</div>
          <div className="stat-icon">⟳</div>
        </div>
        <div className="stat-card" style={{ '--stat-color': 'var(--status-failed)' } as React.CSSProperties}>
              ...
              <tr>
                <td colSpan={6}>
                  <div className="empty-state">
                    ...
                    <div className="empty-desc">// create your first scheduled task to get started</div>
                    <Link href="/tasks/new" className="btn btn-primary">
                      + Create Task
                    </Link>
                  </div>
